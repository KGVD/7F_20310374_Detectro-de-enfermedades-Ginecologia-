# -*- coding: utf-8 -*-
"""
Created on Sat Dec  7 12:40:12 2023
    ...
    if Eleccion == 1:
        while True:
            ...
            if guessed_Sintomas:
                ...
                new_Enfermedad = input("Ingresa la enfermedad: ")
                new_Sintoma1 = input("Sangrado anormal: ")
                new_Sintoma2 = input("Presión pélvica: ")
                new_Sintoma3 = input("Dificultad de embarazo: ")
                new_Sintoma4 = input("Flujo de sangrado: ")
                new_Sintoma5 = input("Sensación de distensión: ")
                new_Sintoma6 = input("Menstruación irregular: ")
                new_Sintoma7 = input("Incontinencia: ")
                new_Sintoma8 = input("Prolapso: ")
                new_Sintoma9 = input("Dolor sexo: ")
                new_Sintoma10 = input("Secreciones: ")
                new_Sintoma11 = input("Picazón: ")
                new_Sintoma12 = input("Enfermo constante: ")
                new_Sintoma13 = input("Cansancio: ")
                new_Sintoma14 = input("Pérdida de peso: ")
                new_Sintoma15 = input("Llagas: ")
                new_Sintoma16 = input("Inflamación ganglios: ")
                new_Sintomas = Sintomas(new_Enfermedad, new_Sintoma1, new_Sintoma2, new_Sintoma3, new_Sintoma4, new_Sintoma5, new_Sintoma6, new_Sintoma7, new_Sintoma8, new_Sintoma9, new_Sintoma10, new_Sintoma11, new_Sintoma12, new_Sintoma13, new_Sintoma14, new_Sintoma15, new_Sintoma16)
                Enfermedades.append(new_Sintomas)
                save_Enfermedades('Doctor.txt', Enfermedades)
                print(f"Agregado: {new_Enfermedad}")
